...
update msg model =
    case msg of
        Input newContent -> (Maybe.withDefault 0 (String.toFloat newContent)^2)
        _ ->
            model
...
view model =
     div []
        [ div [ class "row" ]
            [ div [ class "col-md-12" ] [ input [ class "form-control", placeholder "Tamanho do lado", type_ "number", onInput Input, style "margin-right" "10px" ] [] ]
            ]
