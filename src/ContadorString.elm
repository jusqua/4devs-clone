...
view model =
  let
    toText = {output = contadorString model.i1, title = "Contador de Texto", box1 = "Texto"}
  in
    div 
      [ class "card col-md-4 bg-dark" ]
        [ div [ class "card-body bg-dark text-light" ]
          [ h5 [ class "card-title" ] [ text toText.title ],
            div []
              [ textarea [ placeholder toText.box1, onInput Input, style "margin-right" "10px" ] [] ] ],
                  div [ class "row" ] [ div [ class "col-md-12" ] [ span [ class "h6" ] [ text <| "Caractéres: " ++ (String.fromInt toText.output.c) ] ] ],
                  div [ class "row" ] [ div [ class "col-md-12" ] [ span [ class "h6" ] [ text <| "Caractéres sem espaço: " ++ (String.fromInt toText.output.cse) ] ] ],
                  div [ class "row" ] [ div [ class "col-md-12" ] [ span [ class "h6" ] [ text <| "Espaços: " ++ (String.fromInt toText.output.e) ] ] ],
                  div [ class "row" ] [ div [ class "col-md-12" ] [ span [ class "h6" ] [ text <| "Linhas: " ++ (String.fromInt toText.output.l) ] ] ],
                  div [ class "row" ] [ div [ class "col-md-12" ] [ span [ class "h6" ] [ text <| "Vogais: " ++ (String.fromInt toText.output.v) ] ] ],
                  div [ class "row" ] [ div [ class "col-md-12" ] [ span [ class "h6" ] [ text <| "Consoantes: " ++ (String.fromInt toText.output.con) ] ] ],
                  div [ class "row" ] [ div [ class "col-md-12" ] [ span [ class "h6" ] [ text <| "Números: " ++ (String.fromInt toText.output.n) ] ] ]
              ]
