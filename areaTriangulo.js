...
var $author$project$AreaTriangulo$init = A2($author$project$AreaTriangulo$Model, '', '');
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Calcular Área do Triângulo')
							])),
						A2(
						$elm$html$Html$div,
						_List_Nil,
									...
									[
										...
										_List_fromArray(
											[
												...
												$elm$html$Html$text(
												A2($author$project$AreaTriangulo$areaTriangulo, model.base, model.altura))
											]))
									]))
							]))
					]))
...
var $author$project$AreaTriangulo$main = $elm$browser$Browser$sandbox(
	{init: $author$project$AreaTriangulo$init, update: $author$project$AreaTriangulo$update, view: $author$project$AreaTriangulo$view});
