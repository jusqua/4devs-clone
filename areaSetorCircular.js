...
var $author$project$AreaSetorCircular$Model = F2(
	function (i1, i2) {
		return {i1: i1, i2: i2};
	});
...
var $author$project$AreaSetorCircular$update = F2(
	function (msg, model) {
		if (msg.$ === 'Input1') {
			var n = msg.a;
...
var $author$project$AreaSetorCircular$main = $elm$browser$Browser$sandbox(
	{
		init: A2($author$project$AreaSetorCircular$Model, '', ''),
		update: $author$project$AreaSetorCircular$update,
		view: $author$project$AreaSetorCircular$view
	});
_Platform_export({'AreaSetorCircular':{'init':$author$project$AreaSetorCircular$main(
