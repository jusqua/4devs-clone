...
var $author$project$AreaParalelogramo$Model = F2(
	function (i1, i2) {
		return {i1: i1, i2: i2};
	});
...
var $author$project$AreaParalelogramo$update = F2(
	function (msg, model) {
		if (msg.$ === 'Input1') {
			var n = msg.a;
...
var $author$project$AreaParalelogramo$main = $elm$browser$Browser$sandbox(
	{
		init: A2($author$project$AreaParalelogramo$Model, '', ''),
		update: $author$project$AreaParalelogramo$update,
		view: $author$project$AreaParalelogramo$view
	});
_Platform_export({'AreaParalelogramo':{'init':$author$project$AreaParalelogramo$main(
