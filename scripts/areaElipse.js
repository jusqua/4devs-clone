...
var $author$project$AreaElipse$Model = F2(
	function (i1, i2) {
		return {i1: i1, i2: i2};
	});
...
var $author$project$AreaElipse$update = F2(
	function (msg, model) {
		if (msg.$ === 'Input1') {
			var n = msg.a;
...
var $author$project$AreaElipse$main = $elm$browser$Browser$sandbox(
	{
		init: A2($author$project$AreaElipse$Model, '', ''),
		update: $author$project$AreaElipse$update,
		view: $author$project$AreaElipse$view
	});
_Platform_export({'AreaElipse':{'init':$author$project$AreaElipse$main(
