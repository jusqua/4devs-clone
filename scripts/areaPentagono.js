...
var $author$project$AreaPentagono$Model = function (i1) {
	return {i1: i1};
};
...
var $author$project$AreaPentagono$update = F2(
	function (msg, model) {
		var n = msg.a;
...
var $author$project$AreaPentagono$Input = function (a) {
	return {$: 'Input', a: a};
};
...
var $author$project$AreaPentagono$main = $elm$browser$Browser$sandbox(
	{
		init: $author$project$AreaPentagono$Model(''),
		update: $author$project$AreaPentagono$update,
		view: $author$project$AreaPentagono$view
	});
_Platform_export({'AreaPentagono':{'init':$author$project$AreaPentagono$main(
