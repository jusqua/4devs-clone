...
var $author$project$AreaCircunferencia$init = 'Indeterminado';
...
var $author$project$AreaCircunferencia$update = F2(
	function (msg, model) {
		if (msg.$ === 'Input') {
			...
			return $author$project$AreaCircunferencia$areaCircunferencia(newContent);
		} else {
			return model;
		}
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Calcular Área da Circunferência')
							])),
						A2(
						$elm$html$Html$div,
						_List_Nil,
											...
											[
												...
												_List_fromArray(
													[
														...
														$elm$html$Html$Attributes$placeholder('Raio'),
...
var $author$project$AreaCircunferencia$main = $elm$browser$Browser$sandbox(
	{init: $author$project$AreaCircunferencia$init, update: $author$project$AreaCircunferencia$update, view: $author$project$AreaCircunferencia$view});
